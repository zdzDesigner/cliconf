...
" let s:search    = g:dracula#palette.search
let s:search    = ['#A4C2CD', 228]
" let g:dracula#palette.search    = ['#A4C2CD', 228]
...
" call s:h('DraculaSearch', s:yellow, s:none, [s:attrs.inverse])
" call s:h('DraculaSearch', s:comment, s:orange, [s:attrs.inverse])
call s:h('DraculaSearch', s:comment, s:fg, [s:attrs.inverse])
" call s:h('DraculaSearch', s:bglighter, s:fg, [s:attrs.inverse])
" call s:h('DraculaSearch', s:selection, s:fg, [s:attrs.inverse])
