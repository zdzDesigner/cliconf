...
source $CLIENV/nvim/sources/scripts/hmlog.vim
source $CLIENV/nvim/sources/scripts/base.vim
" source $CLIENV/nvim/sources/scripts/replace.vim
...
" syn match   cTodo   contained   "\<\(TODO\|FIXME\):"
" syntax region potionString start=/\/\/\//  end=/\v"/
