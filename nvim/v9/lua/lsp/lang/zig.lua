...
return {
  ...
  -- cmd = { '/home/zdz/Application/zig/lsp/zls.0.11.0/bin/zls' },
  filetypes = { "zig", "zon" },
  ...
  settings = {
    zls = {
      ...
      zig_exe_path = '/home/zdz/Application/zig/zig-linux-x86_64-0.12.0/zig',
      zig_lib_path = '/home/zdz/Application/zig/zig-linux-x86_64-0.12.0/lib',
      -- build_on_save_step = "",
