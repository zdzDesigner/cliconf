...
PATH_ALACRITTY_CONFIG_TPL="$CLIENV/alacritty/alacritty.yml"
PATH_ALACRITTY_CONFIG="$CLIENV/alacritty/.alacritty.yml"
PATH_ALACRITTY_THEMES="$CLIENV/alacritty/.themes"

cp $PATH_ALACRITTY_CONFIG_TPL $PATH_ALACRITTY_CONFIG
sed -i -e "s%\$CLIENV%$CLIENV%" $PATH_ALACRITTY_CONFIG
